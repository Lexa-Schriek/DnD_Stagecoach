...
namespace StagecoachApp
{
    public class SqliteDataAccess
    {
        public static void GenerateDatabase()
        {
            ...
            string Table2 = "CREATE TABLE IF NOT EXISTS \"Item\"( \"itemID\" INTEGER, \"name\" VARCHAR(50) NOT NULL, \"value\" INTEGER NOT NULL, \"description\" TEXT NOT NULL, \"isUpgrade\" BOOLEAN NOT NULL, \"equippedSlot\" INTEGER, \"typeID\" INTEGER, PRIMARY KEY(\"itemID\" AUTOINCREMENT));";
